...
/* harmony import */ var _modules_Liked__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Liked */ "./src/modules/Liked.js");
...
const liked = new _modules_Liked__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class MyNotes {
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"), updatedPost);
      this.makeNoteReadOnly(thisNote);
    } catch (e) {
      console.log("Sorry");
    }
    ...
    try {
      ...
      if (response.data != "You have reached your note limit.") {
        ...
        document.querySelector("#my-notes").insertAdjacentHTML("afterbegin", `
				...
				`);
        let finalHeight; // browser needs a specific height to transition to
        ...
        // when it reached post limits, show a limit message
...
class Search {
  ...
  getResults() {
    const userSearch = fetch(universityData.root_url + "/wp-json/university/v1/search?term=" + this.searchField.value);
    userSearch.then(res => res.json()).then(results => {
      this.resultsDiv.innerHTML = `
				<div class="row">

					<div class="one-third">
						<h2 class="search-overlay__section-title">General Information</h2>
						${results.generalInfo.length ? `<ul class="link-list min-list">` : "<p>No general inforamtion matches that search.</p>"}
					...
					<div class="one-third">
						...
						${results.campuses.length ? `<ul class="link-list min-list">` : `<p>No campuses match that search. <a href="${universityData.root_url}/campuses">View all campuses</a></p></p>`}
						...
						${results.events.length ? "" : `<p>No events match that search. <a href="${universityData.root_url}/events">View all events</a></p></p>`}
			...
			<div class="search-overlay" id="search-overlay">
				<div class="search-overlay__top">
					<div class="container">
						...
						<input autocomplate="off" type="text" class="search-term" placeholder="What are you looking for?" id="search-term">
