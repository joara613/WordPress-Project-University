	...
	function wordFilterPage(){ ?>
		<div class="wrap">
			...
			<form method="POST">
				...
				<!-- 1. action name / 2. name of nonce value -->
	...
	function optionsSubPage(){ ?>
		<div class="wrap">
			...
			<form action="options.php" method="POST">
				<?php
					// for submenu settings_errors() is needed, if plugins are registered as a settings page under the WP setting menu, it is default
					settings_errors();
